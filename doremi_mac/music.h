...
public:
    explicit Music(std::string _name = "", int _channal_num = 1, int _speed = 80, int _length = 32);

    /**
     * TODO: Add read_file method in "music.cpp"!
     * @note adding an int parameter k avoids collision between two constructors.
     * @brief TODO:
     * @author TODO:
     */
    explicit Music(int k, std::string file_path);

    /**
     * TODO: Add save_file method in "music.cpp"!
     * @brief TODO:
     * @author TODO:
     */
