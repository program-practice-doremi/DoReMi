...
void piano::setPicture(int type) {
    ...
    if(type>=0&&type<=7){
        this->ui->pushButton->setStyleSheet("#pushButton{"
            "background-image: url(:/image/instruments/07.png);" // 按钮背景
            "background-position: center;"
            "}");
    }
    else if(type==8){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/8.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==9){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/9.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==10){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/10.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==11){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/11.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==12){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/12.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==13){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/13.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==14){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/14.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==15){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/15.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type>=16&&type<=20){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/1620.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==21||type==23){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/2123.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==22){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/22.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type>=24&&type<=31){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/2431.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type>=32&&type<=39){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/3239.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==40||type==44||type==45){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/404445.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==41){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/41.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==42||type==43){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/4243.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==46){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/46.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==47){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/47.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type>=48&&type<=51){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/4851.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type>=52&&type<=54){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/5254.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==55){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/55.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==56||type==59){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/5659.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==57){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/57.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==58){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/58.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==59){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/59.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type>=60&&type<=62){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/6062.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type>=64&&type<=67){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/6467.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type>=68&&type<=71){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/6871.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if((type>=72&&type<=77)||type==79){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/727779.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==78){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/78.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type>=80&&type<=103){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/80103.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==104){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/104.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==105){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/105.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==106){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/106.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==107){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/107.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==108){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/108.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==109){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/109.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==110){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/110.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==111){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/111.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==112){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/112.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==113){
        ...
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/114.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==115){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/115.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type>=116&&type<=118){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/116118.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else if(type==119){
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/119.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
    else{
        this->ui->pushButton->setStyleSheet("#pushButton{"
                                            "background-image: url(:/image/instruments/120127.png);" // 按钮背景
                                            "background-position: center;"
                                            "}");
    }
